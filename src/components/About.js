        ...
        <div className="detcontextbox">
            <div className="aboutboxwrap">
              <div className="aboutbox" onMouseEnter={this.onHoverChangeTBaboutdet} onMouseLeave={this.onHoverLeave}>
                ...
                <br/>Born Iraq, grew up New Zealand, bounced around a bunch and am currently residing in the UK. Professional gig-hitter, footage head, web mujrim, & maker on the best & worst days.<br/></p>
