...
export default class Footdetail extends Component {
    ...
    super(props);
    this.state = {
      thewords : ["LOVE PILES OF FALLEN LEAVES & WET GRASS", "SPEAK UP - SAY WHAT - NOT SURE - ANOTHER DAY", "HARD TO REMEMBER & EASY TO FORGET", "LIKE AN ALLEY WHERE REFUSE IS DISCARDED", "HOLLOWED GROUND FOR THOSE WHO WANT, FOR THOSE WHO NEED", "DOVES OF A FLOCK ALL LOOK THE SAME SPICED & STEWED", "LONG NIGHTS SPENT, LONG NIGHTS PENT, LONG NIGHTS NEED A TENT", "IF YOU ASK ME ETERNITY WOULD HAVE BEEN KINDER", "LOOKING FOR KIND & RESERVED CATS : CAN PROVIDE COMPANY", "HAIR LIKE PIANO WIRE, FACE LIKE WORN TYRES"],
